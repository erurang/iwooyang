    ...
    <main>
      ...
      <div>
        ...
        <Image
          ...
          height="0"
          sizes="100vw"
          className="w-full h-72 mb-16 md:mb-32"
        />
        <div className="md:grid md:items-start grid-cols-[1fr,1fr,2fr,1fr]">
          ...
          <div className="px-4 md:items-center">
            <p className="text-[#666666] pb-10">
              저희 우양신소재는 1994년 창립 이래 다양한 현장의 목소리에 귀
              기울여 언제나 현장의 문제 해결사 역할을 자처해 왔습니다. <br />
              <br />
              덕분에 단순한 이론으로 습득한 지식이 아닌 현장 중심의 생생한
              살아있는 정보들을 바탕으로 저온에서 1000°C 이상의 고온에
              이르기까지 맞춤형 소재 선택에서부터 가공 및 응용제품에 이르기까지
              원스톱 솔루션이 가능한 복합 신소재 전문 회사로 거듭날 수
              있었습니다. <br />
              <br />늘 현재에 안주하지 않고, 끊임없이 분석하고 도전하여
              적재적소에 꼭 필요한 고객 맞춤형 솔루션을 그 누구보다 정확하고
              빠르게 전달드릴 수 있도록 오늘도 발로 뛰는 우양신소재가 될 것임을
              약속드립니다.
            </p>
